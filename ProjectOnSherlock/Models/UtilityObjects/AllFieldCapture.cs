...
using ProjectOnSherlock.Models.UtilityObjects;
using ProjectOnSherlock.Models.UtilityObjects.HealthEnum;
using ProjectOnSherlock.Models.UtilityObjects.LoanEnum;
using ProjectOnSherlock.Models.UtilityObjects.PPIEnum;
using System;

namespace ProjectOnSherlock.UtilityObjects
{
    public class AllFieldCapture
    {
        ...
        //Solar
        public ProjectOnSherlock.Models.UtilityObjects.SolarPropertyTypeEnum SolarPropertyType { get; set; }
        ...
        public ProjectOnSherlock.Models.UtilityObjects.AccidentType AccidentType { get; set; }
