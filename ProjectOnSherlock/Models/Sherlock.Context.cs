...
namespace ProjectOnSherlock.Models
{
    ...
    public partial class SherlockEntities : DbContext
    {
        ...
        public virtual ObjectResult<FINAL3_SP_LEADINFO_DATA_Result> FINAL3_SP_LEADINFO_DATA(Nullable<int> productid, Nullable<System.DateTime> startDate, Nullable<System.DateTime> endDate, Nullable<System.DateTime> trnsfrStart, Nullable<System.DateTime> trnsfrEnd, string websiteName, string leadStatus, string buyerName, string fullName, string email, string workPhone, string homePhone, Nullable<int> leadId, string sortColumnName, Nullable<int> rowsPerPage, Nullable<int> pageNumber)
        {
